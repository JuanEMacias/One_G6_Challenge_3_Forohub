...
public class AutenticacionController {
    ...
    public ResponseEntity<DatosJWTtoken> autenticarUsuario(@RequestBody DatosAutenticacionUsuario datosAutenticacionUsuario) {
        ...
        String tokenJWT = tokenService.generarToken((User) usuarioAutenticado.getPrincipal());
        System.out.println("**********tokenJWT" + tokenJWT);
        DatosJWTtoken response = new DatosJWTtoken(tokenJWT, ((User) usuarioAutenticado.getPrincipal()).getNombre());
