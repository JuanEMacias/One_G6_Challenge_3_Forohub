...
public class Respuesta {
    ...
    public Respuesta(RegistrodeRespuesta respuestaDTO, User autor, Topic topico) {
    ...
    public void actualizarDatos(RegistrodeRespuesta.DatosActualizarRespuestas datosActualizarRespuestas) {
